...
<head>
    ...
    <style>
        ...
        .toggle-switch label {
            font-size: .95rem; font-weight: 600; color: #99b898; cursor:pointer;
        }
        ...
        .toggle-switch input[type="checkbox"]:checked { background: #99b898; }
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 position-relative">
                ...
                <div class="content-wrapper">
                    <div class="title-box mb-4">
                        ...
                        <small class="text-light">Seleccione el curso que desea visualizar:</small>
                    </div>
