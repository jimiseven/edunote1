...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2026 a las 03:17:07
...
--
-- Estructura de tabla para la tabla `dias_no_lectivos`
--
...
CREATE TABLE `estudiantes_responsables` (
  ...
  `telefono_responsable` varchar(80) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `estudiantes_responsables_carga`
--

CREATE TABLE `estudiantes_responsables_carga` (
  `id_estudiante` int(11) NOT NULL,
...
CREATE TABLE `personal` (
  ...
  `celular` varchar(80) DEFAULT NULL COMMENT 'Ej: Numero de contacto del usuario',
...
--
-- Indices de la tabla `dias_no_lectivos`
--
...
--
-- Indices de la tabla `estudiantes_responsables_carga`
--
ALTER TABLE `estudiantes_responsables_carga`
  ADD PRIMARY KEY (`id_estudiante`);
...
--
-- AUTO_INCREMENT de la tabla `dias_no_lectivos`
--
ALTER TABLE `dias_no_lectivos`
...
--
-- Filtros para la tabla `dias_no_lectivos`
--
ALTER TABLE `dias_no_lectivos`
...
--
-- Filtros para la tabla `estudiantes_responsables_carga`
--
ALTER TABLE `estudiantes_responsables_carga`
  ADD CONSTRAINT `fk_erc_estudiante` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiantes` (`id_estudiante`) ON DELETE CASCADE ON UPDATE CASCADE;
