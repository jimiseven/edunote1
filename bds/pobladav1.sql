...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2025 a las 23:11:46
...
(10, 'baner 1', '2025-04-15', '2025-04-17', 1, '2025-04-16 00:54:56'),
(11, 'baneer 2', '2025-04-15', '2025-04-17', 1, '2025-04-16 00:55:07'),
(12, 'banner 4', '2025-04-15', '2025-04-23', 1, '2025-04-16 01:01:15');
...
(1, 1, 1, '2025-04-15', '2025-04-17', '2025-04-16 02:02:07'),
(2, 2, 1, NULL, NULL, '2025-04-16 02:02:07'),
(3, 3, 1, NULL, NULL, '2025-04-16 02:02:07');
...
(850, 307, 807, 1, 71.00, NULL),
(851, 306, 807, 2, 82.00, NULL),
(852, 304, 807, 2, 83.00, NULL),
(853, 301, 807, 2, 84.00, NULL),
(854, 309, 807, 2, 85.00, NULL),
(855, 302, 807, 2, 86.00, NULL),
(856, 5, 807, 2, 87.00, NULL),
(857, 305, 807, 2, 88.00, NULL),
(858, 310, 807, 2, 89.00, NULL),
(859, 303, 807, 2, 90.00, NULL),
(860, 308, 807, 2, 91.00, NULL),
(861, 307, 807, 2, 92.00, NULL),
...
INSERT INTO `materias` (`id_materia`, `nombre_materia`, `es_submateria`, `materia_padre_id`) VALUES
(1, 'Matemáticas', 0, NULL),
(2, 'Lenguaje', 0, NULL),
(3, 'Ciencias Naturales', 0, NULL),
(4, 'Historia', 0, NULL),
(800, 'Desarrollo Socioemocional', 0, NULL),
(801, 'Lenguaje y Comunicación', 0, NULL),
(802, 'Exploración del Entorno', 0, NULL),
(803, 'Psicomotricidad', 0, NULL),
(804, 'Biologia', 0, NULL),
(805, 'Fisica', 1, 804),
(806, 'Quimica', 1, 804),
(807, 'Ciencias Naturales', 1, 804);
...
--
ALTER TABLE `calificaciones`
  MODIFY `id_calificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=906;
...
--
ALTER TABLE `cursos_materias`
  MODIFY `id_curso_materia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=912;
...
--
ALTER TABLE `materias`
  MODIFY `id_materia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=808;
...
--
ALTER TABLE `profesores_materias_cursos`
  MODIFY `id_profesor_materia_curso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1011;
